...
<table class="readTable">
	...
	<tr>
		...
		<td class="readTd" colspan="3">
			<input type="text" name="linklist" id="linklist" size="50" 
				maxlength="50" value="${p.linklist }"/>
		</td>				
	</tr>
	<tr>
		<th class="readTh">내&nbsp;&nbsp;용</th>
		<td class="readTd" colspan="3">
			<textarea name="gesimul" id="gesimul" rows="20" 
				cols="72">${p.gesimul } </textarea>
		</td>				
	</tr>
