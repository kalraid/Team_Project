...
public class Project {
	...
	public Project(int no , String id , String linklist, String gesimul, int tableNum,String people,Timestamp dbdate,String good,String File1, int recommend , int thank) {
		this.no = no;
		this.id = id;
