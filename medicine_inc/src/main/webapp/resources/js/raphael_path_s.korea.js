	...
	for (var state in aus) {
		...
		(function (st, state) {
			...
			st[0].onclick = function () {
				...
				switch(state) {
					case "seoul":
						location.href = loc+"?area=서울";
						current = state;
						break;
					case "gygg":
						location.href= loc+"?area=경기";
						current = state;
						break;
					case "incheon":
						location.href= loc+"?area=인천";
						current = state;
						break;
					case "gangwon":
						location.href= loc+"?area=강원";
						current = state;
						break;
					case "chungbuk":
						location.href= loc+"?area=충북";
						current = state;
						break;
					case "chungnam":
						location.href= loc+"?area=충남";
						current = state;
						break;
					case "daejeon":
						location.href= loc+"?area=대전";
						current = state;
						break;
					case "sejong":
						location.href= loc+"?area=세종시";
						current = state;
						break;
					case "jeonbuk":
						location.href= loc+"?area=전북";
						current = state;
						break;
					case "gwangju":
						location.href= loc+"?area=광주";
						current = state;
						break;
					case "jeonnam":
						location.href= loc+"?area=전남";
						current = state;
						break;
					case "gyeongbuk":
						location.href= loc+"?area=경북";
						current = state;
						break;
					case "daegu":
						location.href= loc+"?area=대구";
						current = state;
						break;
					case "gyeongnam":
						location.href= loc+"?area=경남";
						current = state;
						break;
					case "ulsan":
						location.href= loc+"?area=울산";
						current = state;
						break;
					case "busan":
						location.href= loc+"?area=부산";
						current = state;
						break;
					case "jeju":
						location.href= loc+"?area=제주";
						current = state;
						break;
